...
inline static std::unordered_map<std::string, uint32_t> keys = {
    ...
    //new
    {"FcamIntrinsics", PERSISTENT},
    {"EcamIntrinsics", PERSISTENT},
    {"FcamCalibResult", PERSISTENT},
    {"WideCalibResult", PERSISTENT},
    {"PendingCalibReset", PERSISTENT},
    {"WideCalibActive", CLEAR_ON_MANAGER_START},
    {"WideCalibMode", CLEAR_ON_MANAGER_START},
    ...
    {"FallbackActive", CLEAR_ON_MANAGER_START},
};
